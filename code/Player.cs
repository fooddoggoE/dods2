...
partial class DeathmatchPlayer : Player
{
	...
	public static bool Assault = true;
	public static bool MG;
	public static bool Rifleman;
	...
	public override void Respawn()
	{
		...
		if (Assault == true) 
		{
			SetBodyGroup("Classes", 1);
		}

		if (MG == true) 
		{
			SetBodyGroup("Classes", 2);
		}

		if (Rifleman == true) 
		{
			SetBodyGroup("Classes", 3);
		}

		if (Rocket == true) 
		{
			SetBodyGroup("Classes", 4);
		}

		if (Sniper == true) 
		{
			SetBodyGroup("Classes", 5);
		}
	...
	public static void ChangeClass(string Class) 
	{
		...
		if (Class == "Assault" || Class == "assault") 
		{
			Assault = true;
			Sniper = false;
			Rocket = false;
		...
		if (Class == "MG" || Class == "mg" || Class == "Mg" || Class == "mG") 
		{
			MG = true;
			Sniper = false;
			Rocket = false;
		...
		if (Class == "Rifleman" || Class == "rifleman") 
		{
			Rifleman = true;
			Sniper = false;
			Rocket = false;
		...
		if (Class == "Support" || Class == "support") 
		{
			Support = true;
			Sniper = false;
			Rocket = false;
		...
		Log.Info($"{caller} is switching to {Class}");
